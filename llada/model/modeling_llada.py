...
class LLaDABlock(nn.Module):
    ...
    def _scaled_dot_product_attention(
        ...
        """
        # Flash-attn can't return attention scores, so skip it when scores are requested
        if self.flash_attn_func is not None and attn_mask is None and not return_attn_scores:
